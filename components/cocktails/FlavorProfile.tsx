...
export function FlavorProfile({ profile }: FlavorProfileProps) {
  ...
  return (
    <div className="bg-white p-6 rounded-3xl border border-mist shadow-sm h-full">
        ...
        {activeAttributes.map((attr) => {
          ...
          return (
            <div key={attr.key}>
              ...
              <div className="h-2.5 w-full bg-mist rounded-full overflow-hidden">
                <div 

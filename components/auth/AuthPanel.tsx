...
export function AuthPanel({
  ...
  return (
    <div className="rounded-3xl border border-mist bg-white p-6 sm:p-8">
      <h2 className="font-display text-2xl font-bold text-forest">Create your free account</h2>
      <p className="mt-2 text-sm text-sage">
      ...
      {convertHref && (
        <a
          href={convertHref}
          className="mt-6 flex w-full items-center justify-center rounded-2xl bg-terracotta px-4 py-3 font-bold text-cream shadow-lg shadow-terracotta/20 transition-colors hover:bg-terracotta-dark"
        >
          Create my account with this email
        </a>
      )}

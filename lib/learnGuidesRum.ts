...
export const RUM_CURRICULUM_GUIDES: LearnGuide[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        kind: "mistakes",
        body: [
          "Gold or dark on the label used as an age grade → smell the rum, or read still / age / dosage if they print it.",
          "Captain Morgan or Sailor Jerry poured as the aged bottle → switch to Flor de Caña 7, Mount Gay Eclipse, or similar for oak and body.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        kind: "mistakes",
        body: [
          "A dark bottle assumed to mean more oak → taste whether the weight is oak or sugar, and check still / age / dosage if they print it.",
          "Every white rum treated as unaged agricole → use a Spanish-style mixing white for a standard Daiquiri; reach for Clément Blanc or similar only when you want grassy cane.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        kind: "mistakes",
        body: [
          "A dark bottle poured because of the Hemingway story → use a clean mixing white and shake hard.",
          "Navy rum treated as any dark bottle → use ~57% ABV with real body that holds ginger, not a darker tint.",
          "One tiki-blend bottle in the Mai Tai → start with an aged frame, then add a Jamaican fraction until the lime still reads.",
        ],
      },
    ],
    sources: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        kind: "mistakes",
        body: [
          "Style named from the label before the glass → smell first, write two words, then name it.",
          "Every aromatic rum called “spiced” → if it smells like banana, pineapple, or solvent, treat it as esters, not a spice blend.",
          "Six bottles tasted in a rush and none remembered → two rums, same glass, write two words each.",
        ],
      },
    ],
    sources: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        kind: "mistakes",
        body: [
          "One bottle used for every rum drink → clean white for Daiquiri and Mojito; aged weight for ginger; aged frame plus a Jamaican splash for Mai Tai.",
          "Mint shredded and the drink tastes grassy → press the leaves, keep the mixing white clean, and taste before you change bottles.",
          "A single “tiki rum” bought to skip blending → aged Barbados or Spanish-style frame, then funk as a fraction until the lime still reads.",
        ],
      },
    ],
    sources: [

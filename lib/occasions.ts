...
export const OCCASIONS: OccasionDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Dive into Christmas, Halloween, Thanksgiving, New Year’s, Cinco de Mayo, Derby Day, and more — then keep browsing sibling collections.",
    accentClass: "from-forest/15 via-cream to-cream",
    matchTokens: ["holiday", "christmas", "thanksgiving", "halloween", "winter", "nye", "valentine", "st-patricks", "cinco", "derby"],
    coverSlugs: ["eggnog", "peppermint-martini", "coquito", "wassail"],
    staticCoverPath: "/occasions/holidays.jpg",
    childSlugs: ["halloween", "thanksgiving", "christmas", "new-years", "valentines", "st-patricks", "derby", "cinco-de-mayo"],
  },
  {
    slug: "christmas",
    name: "Christmas",
  ...
  },
  {
    ...
    name: "Kentucky Derby",
    navName: "Derby",
    headline: "Mint, crushed ice, and race-day whiskey",
    description: "Juleps and whiskey smashes for Derby weekend — cold, minty, and built for a crowd.",
    accentClass: "from-olive/25 via-cream to-cream",
    matchTokens: ["derby", "julep"],
    coverSlugs: ["mint-julep", "whiskey-smash"],
    parentSlug: "holidays",
    matchExtra: (c) => /julep/i.test(c.name || ""),
  },
  {
    slug: "cinco-de-mayo",
    name: "Cinco de Mayo",
    headline: "Agave, lime, and patio energy",
    description: "Margaritas, Palomas, and tequila highballs for May gatherings — bright, salty, and easy to batch.",
    accentClass: "from-terracotta/25 via-cream to-cream",
    matchTokens: ["cinco", "cinco-de-mayo"],
    coverSlugs: ["paloma", "margarita", "ranch-water"],
    parentSlug: "holidays",
    matchExtra: (c) => /margarita|paloma|ranch water|tequila sunrise/i.test(c.name || ""),
  },
  {
    slug: "party",
  ...
  },
  {
    slug: "winter",
    name: "Winter",
    headline: "Warming cups and cold-night pours",
    description: "Toddies, mulled wine, and richer spirit-forward drinks for short days and long evenings.",
    accentClass: "from-forest/20 via-cream to-cream",
    matchTokens: ["winter"],
    coverSlugs: ["hot-toddy", "mulled-wine", "irish-coffee", "hot-buttered-rum"],
    matchExtra: (c) => /toddy|mulled|buttered rum|irish coffee/i.test(c.name || ""),
  },
  {
    slug: "frozen",
    name: "Frozen",
    headline: "Blended, slushy, and blender-loud",
    description: "Daiquiris, coladas, and frozen margaritas — crushed ice and vacation texture.",
    accentClass: "from-olive/20 via-cream to-cream",
    matchTokens: ["frozen", "blended"],
    coverSlugs: ["strawberry-daiquiri", "pina-colada", "frozen-margarita"],
  },
  {
    slug: "tropical",
    name: "Tropical",
    headline: "Pineapple, coconut, and sun-drenched fruit",
    description: "Island-leaning drinks with pineapple, coconut, and rum — vacation in a glass, tiki optional.",
    accentClass: "from-olive/15 via-cream to-cream",
    matchTokens: ["tropical", "coconut", "pineapple"],
    coverSlugs: ["pina-colada", "blue-hawaiian", "mai-tai", "jungle-bird"],
  },
  {
    slug: "highballs",
    name: "Highballs",
    headline: "Tall, cold, and easy to repeat",
    description: "Spirit plus lengthener — gin and tonic, Paloma, mule, and other sessionable builds.",
    accentClass: "from-olive/25 via-cream to-cream",
    matchTokens: ["highball", "collins", "mule"],
    coverSlugs: ["gin-and-tonic", "paloma", "irish-mule", "dark-n-stormy"],
  },
  {
    slug: "sours",
    name: "Sours",
    headline: "Spirit, citrus, and sugar — the template",
    description: "Daiquiris, whiskey sours, margaritas, and other shaken citrus drinks that teach the ratio.",
    accentClass: "from-terracotta/20 via-cream to-cream",
    matchTokens: ["sour", "daiquiri", "margarita"],
    coverSlugs: ["daiquiri", "whiskey-sour", "margarita", "clover-club"],
  },
  {
    slug: "sparkling",
    name: "Sparkling",
    headline: "Champagne, prosecco, and bubble-forward pours",
    description: "French 75s, spritzes, and sparkling wine cocktails for brunch, toasts, and late nights.",
    accentClass: "from-olive/20 via-cream to-cream",
    matchTokens: ["sparkling", "champagne", "prosecco"],
    coverSlugs: ["french-75", "champagne-cocktail", "kir-royale", "bellini"],
  },
  {
    slug: "easy",
    name: "Easy Two- & Three-Ingredient",
    navName: "Easy",
    headline: "Short lists, fast pours",

...
| File | Guide |
|------|--------|
| `/media/kitchen-shelf.webp` | Home bar fundamentals |
| `cocktail-templates.webp` | Cocktail templates (generated) |
| `ice-and-dilution.webp` | Ice and dilution (generated) |
...
| `learn-whiskey-manhattan.webp` | Whiskey history cover + Manhattan / history slides (CC photo; see ATTRIBUTION.md) |
...
| File | Topic |
|------|--------|
| `method-shake.webp` | Shake |
| `method-stir.webp` | Stir |
| `method-build.webp` | Build / highball |
| `method-blend.webp` | Blend |
| `method-layer.webp` | Layer |
| `technique-dry-shake.webp` | Dry shake |
| `technique-fine-strain.webp` | Fine strain |
| `technique-muddle.webp` | Muddle |
| `technique-express.webp` | Express |
